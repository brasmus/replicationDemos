...
print("Demonstration why the argument in Scafetta (2012), p. 9 section 3")
...
plot(x,y,type="l", lwd=2, col="grey20", main="NINO3.4 curve fit",xlim=range(x[ii]),
     sub="Scafetta (2012): ...distinguishes a mere curve fitting exercise.. p. 9")
...
dev.new()
plot(x,y,type="l", lwd=2, col="grey40", main="NINO3.4: extending curve-fit (Scafetta, 2012, p. 8)",
